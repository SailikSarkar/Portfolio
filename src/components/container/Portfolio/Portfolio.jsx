        ...
        {works.map((work) => {
          return (
            ...
            >
              ...
              <img className='img-work' src={work.img} alt="workImg" />
              ...
              <h3 className='work-image-title'> { work.Name} </h3>

              
              
<div className='work-icons'>
              <a className='work-contact' href={ work.Gitlink} target="_blank">
                  < FiGithub />
                </a>
                  
                <a className='work-contact' href={ work.Viewlink} target="_blank">
                  <FiEye />
                </a>
                </div>
